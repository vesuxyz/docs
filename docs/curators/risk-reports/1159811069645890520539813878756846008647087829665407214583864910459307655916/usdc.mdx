---
title: Vesu USDC Alterscope Cornerstone Risk Report
sidebar_label: vUSDC-AlterscopeCornerSt
sidebar_position: 4
slug: /curators/risk-reports/1159811069645890520539813878756846008647087829665407214583864910459307655916/usdc
---
...
The *Vesu USDC Alterscope Cornerstone* market represents `USDC` deposits in Alterscope's *Alterscope Cornerstone* pool.
...
`USDC` deposits in this pool can be borrowed with all other pool assets as collateral including `ETH`, `WBTC`, `STRK` and `USDT`.
