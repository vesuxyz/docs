---
title: Vesu WBTC Braavos Vault Risk Report
sidebar_label: vWBTC-bv
sidebar_position: 4
slug: /curators/risk-reports/1921054942193708428619433636456748851087331856691656881799540576257302014718/wbtc
---
...
The *Vesu WBTC Braavos Vault* market represents `WBTC` deposits in Braavos' *Braavos Vault* pool.
...
`WBTC` deposits in this pool are only enabled as collateral and are not available for others to borrow.
...
The pool does not enable collateral asset *rehypothecation*.
