---
title: Vesu Ether CarmineDAO Runes Risk Report
sidebar_label: vETH-CarmineDAORunes
sidebar_position: 2
slug: /curators/risk-reports/2681185522664180117929158590481443496806090795357786716961716864181408932939/eth
---
...
The *Vesu Ether CarmineDAO Runes* market represents `ETH` deposits in Carmine DAO's *CarmineDAO Runes* pool.
...
`ETH` deposits can be borrowed with all pool assets as collateral.
...
The pool enables borrowing of `ETH` with any of the pool's assets as collateral. Collateral *rehypothecation* is not enabled in the pool. 
