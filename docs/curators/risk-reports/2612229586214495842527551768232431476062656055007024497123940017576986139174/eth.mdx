---
title: Vesu ETH Alterscope wstETH Risk Report
sidebar_label: vETH-Alterscope wstETH
sidebar_position: 4
slug: /curators/risk-reports/2612229586214495842527551768232431476062656055007024497123940017576986139174/eth
---
...
The *Vesu ETH Alterscope wstETH* market represents ETH deposits in Alterscope's "Alterscope wstETH" pool.
...
The pool enables borrowing of `ETH` only with `wstETH` collateral, which itself achieves a "Low" rating. Collateral *rehypothecation* is not enabled in the pool. 
