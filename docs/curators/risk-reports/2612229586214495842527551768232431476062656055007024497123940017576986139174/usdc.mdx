---
title: Vesu USDC Alterscope wstETH Risk Report
sidebar_label: vUSDC-Alterscope wstETH
sidebar_position: 2
slug: /curators/risk-reports/2612229586214495842527551768232431476062656055007024497123940017576986139174/usdc
---
...
The Vesu USDC-Alterscope wstETH market represents USDC deposits in Alterscope's "Alterscope wstETH" pool.
...
`USDC` deposits can be borrowed with `wstETH` as collateral.
...
The pool enables borrowing of `USDC` only with `wstETH` collateral, which itself achieves a "Low" rating. Collateral *rehypothecation* is not enabled in the pool. 
