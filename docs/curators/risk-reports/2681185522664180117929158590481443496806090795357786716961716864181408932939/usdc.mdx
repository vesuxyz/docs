...
- [Pragma Providers for USDC](https://www.pragma.build/asset/USDC-USD?network=mainnet)
...
The pool enables borrowing of `USDC` with any of the pool's assets as collateral. Collateral *rehypothecation* is enabled in the pool. 
