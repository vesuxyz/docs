...
- [Pragma Providers for BTC](https://www.pragma.build/asset/BTC-USD?network=mainnet)
...
The pool enables borrowing of `WBTC` with any of the pool's assets as collateral. Collateral *rehypothecation* is enabled in the pool. 
