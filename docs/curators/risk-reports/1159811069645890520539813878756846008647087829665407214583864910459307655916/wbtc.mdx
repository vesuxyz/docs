---
title: Vesu WBTC Alterscope Cornerstone Risk Report
sidebar_label: vWBTC-AlterscopeCornerSt
sidebar_position: 4
slug: /curators/risk-reports/1159811069645890520539813878756846008647087829665407214583864910459307655916/wbtc
---
...
The *Vesu WBTC Alterscope Cornerstone* market represents `WBTC` deposits in Alterscope's *Alterscope Cornerstone* pool.
...
`WBTC` deposits in this pool can be borrowed with all other pool assets as collateral including `ETH`, `STRK`, `USDC` and `USDC`.
