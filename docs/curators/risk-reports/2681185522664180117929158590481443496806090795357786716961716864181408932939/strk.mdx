...
- [Pragma Providers for STRK](https://www.pragma.build/asset/STRK-USD?network=mainnet)
...
The pool enables borrowing of `STRK` with any of the pool's assets as collateral. Collateral *rehypothecation* is enabled in the pool. 
