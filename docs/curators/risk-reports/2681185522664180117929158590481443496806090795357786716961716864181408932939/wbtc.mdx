---
title: Vesu wBTC CarmineDAO Runes Risk Report
sidebar_label: vWBTC-CarmineDAORunes
sidebar_position: 5
slug: /curators/risk-reports/2681185522664180117929158590481443496806090795357786716961716864181408932939/wbtc
---
...
The *Vesu wBTC CarmineDAO Runes* market represents `WBTC` deposits in Carmine DAO's *CarmineDAO Runes* pool.
...
- [CoinGecko](https://www.coingecko.com/cs/coins/bitcoin)
- [Voyager](https://voyager.online/contract/0x207a0df236eac7c3a68856df797019553cd56a3729b3407a5085f1ba3905c00)
...
- [Token Contract](https://voyager.online/contract/0x207a0df236eac7c3a68856df797019553cd56a3729b3407a5085f1ba3905c00)
...
`WBTC` deposits can be borrowed with all pool assets as collateral.
...
The pool enables borrowing of `WBTC` with any of the pool's assets as collateral. Collateral *rehypothecation* is not enabled in the pool. 
