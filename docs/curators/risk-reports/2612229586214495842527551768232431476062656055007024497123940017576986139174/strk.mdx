---
title: Vesu STRK Alterscope wstETH Risk Report
sidebar_label: vSTRK-Alterscope wstETH
sidebar_position: 2
slug: /curators/risk-reports/2612229586214495842527551768232431476062656055007024497123940017576986139174/strk
---
...
The Vesu STRK-Alterscope wstETH market represents STRK deposits in Alterscope's "Alterscope wstETH" pool.
...
`STRK` deposits can be borrowed with `wstETH` as collateral.
...
The pool enables borrowing of `STRK` only with `wstETH` collateral, which itself achieves a "Low" rating. Collateral *rehypothecation* is not enabled in the pool. 
