---
title: Vesu STRK Alterscope Cornerstone Risk Report
sidebar_label: vSTRK-AlterscopeCornerSt
sidebar_position: 4
slug: /curators/risk-reports/1159811069645890520539813878756846008647087829665407214583864910459307655916/strk
---
...
The *Vesu STRK Alterscope Cornerstone* market represents `STRK` deposits in Alterscope's *Alterscope Cornerstone* pool.
...
`STRK` deposits in this pool can be borrowed with all other pool assets as collateral including `ETH`, `WBTC`, `USDC` and `USDT`.
