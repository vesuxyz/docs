---
title: Vesu DOG CarmineDAO Runes Risk Report
...
- [CoinGecko](https://www.coingecko.com/en/coins/dog-bitcoin)
...
- [Ordiscan Token Contract](https://ordiscan.com/rune/DOGGOTOTHEMOON)
...
The oracle price is computed as the Median over the most recent data points available for the various [Pragma providers](https://www.pragma.build/asset/DOG-USD?network=mainnet).
The volume behind the data feed concentrates (at the time of publishing this report) mostly in the gate.io, denominated in USDT.
...
- [Pragma Providers for DOG](https://www.pragma.build/asset/DOG-USD?network=mainnet)
