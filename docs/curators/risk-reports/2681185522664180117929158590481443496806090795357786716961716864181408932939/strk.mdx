---
title: Vesu STRK CarmineDAO Runes Risk Report
sidebar_label: vSTRK-CarmineDAORunes
sidebar_position: 3
slug: /curators/risk-reports/2681185522664180117929158590481443496806090795357786716961716864181408932939/strk
---
...
The *Vesu STRK CarmineDAO Runes* market represents `STRK` deposits in Carmine DAO's *CarmineDAO Runes* pool.
...
`STRK` deposits can be borrowed with all pool assets as collateral.
...
The pool enables borrowing of `STRK` with any of the pool's assets as collateral. Collateral *rehypothecation* is not enabled in the pool. 
