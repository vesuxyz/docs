---
title: Vesu WBTC Alterscope xSTRK Risk Report
sidebar_label: vWBTC-Alterscope xSTRK
sidebar_position: 6
slug: /curators/risk-reports/1129317009595740662798266590704690378283717359139782594834794341553978002262/wbtc
---
...
The *Vesu WBTC Alterscope xSTRK* market represents WBTC deposits in Alterscope's *Alterscope xSTRK* pool.
...
`WBTC` deposits can be borrowed with `xSTRK` as collateral.
...
The pool enables borrowing of `WBTC` only with `xSTRK` collateral, which itself achieves a "Medium" rating. Collateral *rehypothecation* is not enabled in the pool. 
