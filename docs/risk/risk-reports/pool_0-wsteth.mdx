...
StarkGate Wrapped stETH (wstETH) is the bridged version of Wrapped stETH (wstETH) on Starknet using the StarkGate bridge.

StarkGate is the canonical bridging protocol of Starknet developed and maintained by StarkWare, the creator of Starknet. 

wstETH has an MCAP of over USD 13bn and TVL on Starknet of over USD 4.5m.

*Datapoints*

- [CoinGecko](https://www.coingecko.com/en/coins/wrapped-steth)
- [StarkScan](https://starkscan.co/token/0x042b8f0484674ca266ac5d08e4ac6a3fe65bd3129795def2dca5c34ecc5f96d2)
...
StarkGate wstETH reflects Ethereum mainnet wstETH that is bridged to Starknet using the StarkGate bridge. 
...
- [Token Contract](https://starkscan.co/token/0x042b8f0484674ca266ac5d08e4ac6a3fe65bd3129795def2dca5c34ecc5f96d2)
...
The lending pool enables borrowing of StarkGate wstETH deposits using any of the other pool assets as collateral.
...
- [Standard Market Risk Model](https://docs.google.com/spreadsheets/d/13NE8h8NA-QS95I6Djn3qjs3fTiSEjTeP3eNFiRB2FIM/edit?usp=sharing)
...
The collateral chain thus spans across all pool assets resulting in that StarkGate wstETH inherits the highest severity risk among all these assets.
