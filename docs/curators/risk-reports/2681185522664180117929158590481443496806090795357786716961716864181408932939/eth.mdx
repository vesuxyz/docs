...
- [Pragma Providers for ETH](https://www.pragma.build/asset/ETH-USD?network=mainnet)
...
The pool enables borrowing of `ETH` with any of the pool's assets as collateral. Collateral *rehypothecation* is enabled in the pool. 
