---
title: Vesu STRK Alterscope xSTRK Risk Report
sidebar_label: vSTRK-Alterscope xSTRK
sidebar_position: 2
slug: /curators/risk-reports/1129317009595740662798266590704690378283717359139782594834794341553978002262/strk
---
...
The *Vesu STRK Alterscope xSTRK* market represents STRK deposits in Alterscope's *Alterscope xSTRK* pool.
...
The pool enables borrowing of `STRK` only with `xSTRK` collateral, which itself achieves a "Medium" rating. Collateral *rehypothecation* is not enabled in the pool. 
