...
sidebar_label: vUSDC-Re7rUSDC
sidebar_position: 5
slug: /curators/risk-reports/1749206066145585665304376624725901901307432885480056836110792804696449290137/usdc
---
...
The *Vesu USDC Re7 rUSDC* market represents `USDC` deposits in Re7 Lab's *Re7 rUSDC* pool.
...
`USDC` deposits in this pool are isolated from borrowing removing market risk for borrower's collateral assets.
