---
title: Vesu USDT Alterscope xSTRK Risk Report
sidebar_label: vUSDT-Alterscope xSTRK
sidebar_position: 2
slug: /curators/risk-reports/1129317009595740662798266590704690378283717359139782594834794341553978002262/usdt
---
...
The *Vesu USDT Alterscope xSTRK* market represents `USDT` deposits in Alterscope's *Alterscope xSTRK* pool.
...
`USDT` deposits can be borrowed with `xSTRK` as collateral.
...
The pool enables borrowing of `USDT` only with `xSTRK` collateral, which itself achieves a "Medium" rating. Collateral *rehypothecation* is not enabled in the pool. 
