---
title: Vesu USDT Alterscope Cornerstone Risk Report
sidebar_label: vUSDT-AlterscopeCornerSt
sidebar_position: 4
slug: /curators/risk-reports/1159811069645890520539813878756846008647087829665407214583864910459307655916/usdt
---
...
The *Vesu USDT Alterscope Cornerstone* market represents `USDT` deposits in Alterscope's *Alterscope Cornerstone* pool.
...
The pool uses Pragma's `USDT/USD` price feed.
...
`USDT` deposits in this pool can be borrowed with all other pool assets as collateral including `ETH`, `WBTC`, `STRK` and `USDC`.
