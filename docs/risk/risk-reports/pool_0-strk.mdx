...
StarkGate Starknet (STRK) is the bridged version of Starknet (STRK) on Starknet using the StarkGate bridge.

StarkGate is the canonical bridging protocol of Starknet developed and maintained by StarkWare, the creator of Starknet. 

STRK has an MCAP of over USD 1.7bn and TVL on Starknet of over USD 1.3bn.

*Datapoints*

- [CoinGecko](https://www.coingecko.com/en/coins/starknet)
- [StarkScan](https://starkscan.co/token/0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d)
...
- [Token Contract](https://starkscan.co/token/0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d)
...
The lending pool enables borrowing of StarkGate STRK deposits using any of the other pool assets as collateral.
...
The collateral chain thus spans across all pool assets resulting in that StarkGate STRK inherits the highest severity risk among all these assets.
